...
const data = returnJson("Data.json");
...
console.log(howMuchMoneyWasSpendInYear(data, 2014));
...
function whatCompanyIsEarningHowMuch(dataArray) {
  ...
  for (let i = 0; i < dataArray.length; i++) {
    if (dataArray[i].detailsOfPayent.company == "ECSTASIA") {
      ...
      console.log("error: wrong company");
    }
  }
...
console.log(whatCompanyIsEarningHowMuch(data));
...
function whatTypeOfTransactionWasHavingWhatSpendings(dataArray) {
  ...
  for (let i = 0; i < dataArray.length; i++) {
    if (dataArray[i].detailsOfPayent.Type == 1) {
      ...
      console.log("error: wrong transaction type");
    }
  }
...
console.log(whatTypeOfTransactionWasHavingWhatSpendings(data));
...
console.log(howMuchMoneyWasSpendInEachMonth(data));
...
console.log(eachDayOfTheWeekSpending(data));
